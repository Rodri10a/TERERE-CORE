...
DEFAULT_LEVELS = {
    1: {
        ...
        "bg_image": "capiata/stage_capiata.png",
        "score_bonus": 300,
        "enemy_start_x": 600,
        "enemy": {"speed": 3, "health": 130, "damage": 10},
        "minigame": "chipa_rush",
        "platforms": [
    ...
    2: {
        ...
        "bg_image": "san_lorenzo/stage_san_lorenzo.jpg",
        "score_bonus": 500,
        "enemy_start_x": 580,
    ...
    3: {
        ...
        "bg_image": "luque/stage_luque.jpg",
        "score_bonus": 600,
        "enemy_start_x": 450,
    ...
    4: {
        ...
        "background": "ciudad",
        "bg_color": [60, 30, 50],
        "bg_image": "asuncion/stage_asuncion.png",
        "score_bonus": 1000,
        "enemy_start_x": 450,
